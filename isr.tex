...
The need for a standardized set of input metadata drove the need for XXX.

The only truly testable portion of the ISR during DC3a was the identification 
and masking of the cosmic rays sythesized for the exposureId = 1 images.  Jeonghee is looking at this.
...
darks, flats, illumination correction images, pupil correction, linearization tables, 
bad pixel masks, and cross--talk correction matrices.  Each of these requires a
