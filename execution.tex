...
\RHL{Macros such as \texttt{LSST\_EXCEPT\_ADD} are already
used in e.g. \texttt{meas/algorithms}}
...
\RHL{What do we mean by, ``the exact software configuration''? I didn't
think that we yet captured e.g. compiler versions}
...
track down the stage configuration associated with an error, or
