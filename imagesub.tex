...
We note that we were unable to use the simulated images for the image
subtraction portion of {\tt IPSD} since the template images are
severely undersampled (0.1'' seeing with 0.3'' pixels).
...
{\tt ip\_diffim} convolution Kernel.  However, it was subsequently
rewritten in a more advanced form for modeling of the spatially
