...
\begin{figure}[t]
\begin{center}
\includegraphics[width=3in,bb=0 0 366 489]{images/DC3aNightly.pdf}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=4.5in,bb=0 0 537 491]{images/LSSTpipes.pdf}
...
Data objects are passed between stages through a so-called
